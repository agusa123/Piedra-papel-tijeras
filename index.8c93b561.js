...
@media (max-width: 460px) {
  ...
  `,r.appendChild(o);let c=3,l=!1,p=!1,d=setInterval(()=>{--c>0?r.querySelector(".contador").textContent=c.toString():(clearInterval(d),r.querySelector(".contador").textContent="¡Ya!",r.querySelector(".spinner").remove(),p=!0,m())},1e3),m=()=>{["piedra","papel","tijera"].forEach(e=>{r.querySelector(`.img-${e}`)?.removeEventListener("click",()=>u(e))})},u=e=>{if(l||p)return;l=!0;let t=r.querySelector(`.img-${e}`);t.style.transition="transform 0.3s ease-out",t.style.transform="translateY(-30px)",t.style.opacity="1",t.style.height="150px",t.style.width="150px",m()},g="";r.querySelector(".img-piedra")?.addEventListener("click",()=>{u("piedra"),g="piedra"}),r.querySelector(".img-papel")?.addEventListener("click",()=>{u("papel"),g="papel"}),r.querySelector(".img-tijera")?.addEventListener("click",()=>{u("tijera"),g="tijera"});let h=()=>{let e=Math.floor(3*Math.random())+1;return 1==e?r.querySelector(".eleccion-pc").innerHTML=`<img class="img" src=${i} style="transform: rotate(180deg); opacity:1; width:150px; height:150px;">`:2==e?r.querySelector(".eleccion-pc").innerHTML=`<img class="img" src=${t} style="transform: rotate(180deg); opacity:1; width:150px; height:150px;">`:r.querySelector(".eleccion-pc").innerHTML=`<img class="img" src=${a} style="transform: rotate(180deg); opacity:1; width:150px; height:150px;">`,e};var f="";return setTimeout(()=>{let e,t;let i=function(e,t){switch(e){case"piedra":if("tijera"==t)return"pc";if("papel"==t)return"usuario";if("piedra"==t)return"empate";return"pc";case"papel":if("tijera"==t)return"usuario";if("papel"==t)return"empate";if("piedra"==t);return"pc";case"tijera":if("tijera"==t)return"empate";if("papel"==t)return"pc";if("piedra"==t)return"usuario";return"pc"}}(f=1==h()?"piedra":2==h()?"papel":"tijera",g);console.log(i),"pc"==i?(e=1,t=0):"usuario"==i?(e=0,t=1):(e=0,t=0);let n=s.getState(),a={id:n.reduce((e,t)=>t.id>e.id?t:e,n[0]).id+1,eleccionPc:f,eleccionUsuario:g,puntajePc:e,puntajeUsuario:t};n.push(a),s.setState(n)},3e3),r}const l="/Piedra-papel-tijeras";function p(){return location.host.includes("github.io")}class d extends HTMLElement{constructor(){super(),this.tags=["h1","p"],this.tag="p",this.shadow=this.attachShadow({mode:"open"});let e=this.getAttribute("tag")||"p";this.tags.includes(e)&&(this.tag=e),this.render()}render(){let e=document.createElement(this.tag);e.textContent=this.textContent,this.shadow.appendChild(e)}}customElements.define("my-text",d);class m extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){let e=document.createElement("style");e.innerHTML=`
    ...
    `}}customElements.define("button-component",m),location.pathname,function(e){function t(e){let t=p()?l+e:e;history.pushState({},"",t),i(t)}function i(i){for(let n of(p()&&i.replace(l,""),[{path:/\/welcome/,component:r},{path:/\/inicio/,component:o},{path:/\/play/,component:c}]))if(n.path.test(i)){let i=n.component({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(i)}}"/"==location.pathname?t("/welcome"):"/inicio"==location.pathname||"/play"==location.pathname?i(location.pathname):t("/welcome"),window.onpopstate=function(e){i(location.pathname)}}(document.querySelector(".root")),console.log("Hello World");
//# sourceMappingURL=index.8c93b561.js.map
